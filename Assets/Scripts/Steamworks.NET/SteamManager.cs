...
public class SteamManager : MonoBehaviour
{
	...
	protected static string s_LastInitError = string.Empty;
	...
	protected virtual void Awake()
	{
		...
		if (!m_bInitialized)
		{
			s_LastInitError = $"{initResult}: {initError}";
			Debug.LogError($"[Steamworks.NET] SteamAPI_Init() failed. {s_LastInitError}", this);
	...
	public static string LastInitError {
		get {
			return "Steamworks is disabled on this platform.";
		}
	}
